...
function buildWindows () {
  var lib = path.join(__dirname, 'build/lib/libsodium-' + arch + '.dll')
...
function buildLinux () {
  var lib = path.join(__dirname, 'build/lib/libsodium-' + arch + '.so.18')
...
function buildDarwin () {
  var lib = path.join(__dirname, 'build/lib/libsodium-' + arch + '.dylib')
