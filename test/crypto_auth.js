...
test('crypto_auth #1', (t) => {
  ...
  const exp = [
    ...
    new Uint8Array([
      0x7b, 0x9d, 0x83, 0x38, 0xeb, 0x1e, 0x3d, 0xdd, 0xba, 0x8a, 0x9a, 0x35, 0x08, 0xd0, 0x34,
      0xa1, 0xec, 0xbe, 0x75, 0x11, 0x37, 0xfa, 0x1b, 0xcb, 0xa0, 0xf9, 0x2a, 0x3e, 0x6d, 0xfc,
      0x79, 0x80
    ]),
    new Uint8Array([
      0xb9, 0xd1, 0x4c, 0x51, 0xa6, 0xd4, 0xdd, 0x41, 0x60, 0x4e, 0xb0, 0x6c, 0x9c, 0x24, 0x0f,
      0x1f, 0x64, 0xf1, 0x43, 0xb5, 0xcf, 0xde, 0xa3, 0x71, 0x29, 0xb2, 0x8b, 0xb7, 0x5d, 0x13,
      0x71, 0xd3
    ])
  ]
...
test('rfc4231 test case #6', (t) => {
  const keys = [
    ...
    new Uint8Array([
      0x4a, 0x65, 0x66, 0x65, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    new Uint8Array([
      ...
      0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00
    ])
  ]
