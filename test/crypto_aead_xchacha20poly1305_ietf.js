...
test('constants', function (t) {
  ...
  t.is(
    typeof sodium.crypto_aead_xchacha20poly1305_ietf_MESSAGEBYTES_MAX,
    'number'
  )
  t.is(
    sodium.crypto_aead_xchacha20poly1305_ietf_MESSAGEBYTES_MAX,
    Number.MAX_SAFE_INTEGER
  ) // to make sure, see note in binding.c
})
...
test('ported from libsodium', function (t) {
  ...
  const exp2 = Buffer.from([
    ...
    0x0c, 0xb1, 0xd1, 0x53, 0x33, 0xa8, 0x37, 0xb9, 0x09, 0x46, 0xba, 0x38,
    0x54, 0xee, 0x74, 0xda, 0x3f, 0x25, 0x85, 0xef, 0xc7, 0xe1, 0xe1, 0x70,
    0xe1, 0x7e, 0x15, 0xe5, 0x63, 0xe7, 0xe0, 0x96, 0xe0, 0x33, 0xd9, 0x1b,
    0x63, 0xf7, 0xac, 0x92, 0xe9, 0x97, 0x2e, 0x0d, 0x43, 0xe5
  ])
  exp2.secure = true
...
test('non-detached -> detached', function (t) {
  ...
  const csub = c.subarray(
    0,
    clen - sodium.crypto_aead_xchacha20poly1305_ietf_ABYTES
  )
