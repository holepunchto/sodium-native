...
test('ported from libsodium', function (t) {
  ...
  const nonce = new Uint8Array([
    0x07, 0x00, 0x00, 0x00, 0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x4a, 0x4b,
  ...
  const exp1 = Buffer.from([
    
  ])
  exp1.secure = true
  ...
  foundmaclen = sodium.crypto_aead_xchacha20poly1305_ietf_encrypt_detached(
    detachedc,
    mac,
    m,
    ad,
  ...
  const exp2 = Buffer.from([
    ...
    0x19, 0xa9, 0x6e, 0xf1, 0x0c, 0xb1, 0xd1, 0x53, 0x33, 0xa8, 0x37, 0xb9, 0x09, 0x46, 0xba, 0x38,
    0x54, 0xee, 0x74, 0xda, 0x3f, 0x25, 0x85, 0xef, 0xc7, 0xe1, 0xe1, 0x70, 0xe1, 0x7e, 0x15, 0xe5,
    0x63, 0xe7, 0xe0, 0x96, 0xe0, 0x33, 0xd9, 0x1b, 0x63, 0xf7, 0xac, 0x92, 0xe9, 0x97, 0x2e, 0x0d,
    0x43, 0xe5
  ])
  exp2.secure = true
  ...
  foundclen = sodium.crypto_aead_xchacha20poly1305_ietf_encrypt(
    c,
    c.subarray(0, mlen),
    null,
    null,
  ...
  const decrypted = sodium.sodium_malloc(
    c.byteLength - sodium.crypto_aead_xchacha20poly1305_ietf_ABYTES
  )
  m2len = sodium.crypto_aead_xchacha20poly1305_ietf_decrypt(
    decrypted,
    null,
    c,
    null,
...
test('different keys', function (t) {
  ...
  t.exception.all((_) =>
    sodium.crypto_aead_xchacha20poly1305_ietf_decrypt(m1, null, c1, null, nonce, key2)
  )
  t.exception.all((_) =>
    sodium.crypto_aead_xchacha20poly1305_ietf_decrypt(m2, null, c2, null, nonce, key1)
  )

  t.is(
    sodium.crypto_aead_xchacha20poly1305_ietf_decrypt(m1, null, c1, null, nonce, key1),
    m.byteLength
  )
  t.ok(m.equals(m1))
  t.is(
    sodium.crypto_aead_xchacha20poly1305_ietf_decrypt(m2, null, c2, null, nonce, key2),
    m.byteLength
  )
  t.ok(m.equals(m2))
})
...
test('different nonce', function (t) {
  ...
  t.exception.all((_) =>
    sodium.crypto_aead_xchacha20poly1305_ietf_decrypt(m1, null, c1, null, n2, key)
  )
  t.exception.all((_) =>
    sodium.crypto_aead_xchacha20poly1305_ietf_decrypt(m2, null, c2, null, n1, key)
  )
...
test('detached -> non-detached', function (t) {
  ...
  t.is(
    sodium.crypto_aead_xchacha20poly1305_ietf_encrypt_detached(c, mac, m, null, null, nonce, key),
    mac.byteLength
  )
...
test('non-detached -> detached', function (t) {
  ...
  t.is(
    sodium.crypto_aead_xchacha20poly1305_ietf_encrypt(c, m, null, null, nonce, key),
    c.byteLength
  )
